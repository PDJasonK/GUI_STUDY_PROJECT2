...
/* 
 * AdminVocab - VocabToeicMainOut과연관
 * 
 * */

public class UserVocab1 extends WindowAdapter implements ActionListener {
	private JFrame f;
	private JPanel p;
	/*
	...
	UserVocab1DAO dao = new UserVocab1DAO();
	...
	public UserVocab1() {
		...
		f = new JFrame(" First One");
		p = new JPanel();
		p.setLayout(null);

		// -----

		title = new JLabel("단어 출제 [1] [VocabList]본문");
