...
public class AdminReading1 extends WindowAdapter implements ActionListener {
	private JFrame f;
	private JPanel p;
	...
	AdminReading1DAO dao = new AdminReading1DAO();
	...
	public AdminReading1() {
		...
		title = new JLabel("[첫번째 리딩 지문] First Reading ");
...
//		Submit.setBackground(Color.gray);
	...
	public static void main(String[] args) {
		AdminReading1 sm = new AdminReading1();
		sm.startframe();
	}
