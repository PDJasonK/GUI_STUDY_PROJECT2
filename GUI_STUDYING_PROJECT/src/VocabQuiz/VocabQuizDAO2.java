...
public class VocabQuizDAO2 {
	...
	public ArrayList<VocabQuizVo2> list(String Output1, String Output2, String Output3, String Output4, String Output5,
		...
		ArrayList<VocabQuizVo2> list = new ArrayList<VocabQuizVo2>();
		try {
...
//				" and contentsC = '" + contents3.toLowerCase() + "'";
			query = "insert into VocabQuizFinished2(Output1, Output2, Output3, Output4, Output5, Output6, Output7, Output8, Output9, Output10, Output11, Output12, Output13, Output14, Output15, Output16)"
