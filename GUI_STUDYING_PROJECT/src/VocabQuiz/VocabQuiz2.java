...
import UserVocab.UserVocab2;
	...
	public class VocabQuiz2 extends WindowAdapter implements ActionListener {
		...
		VocabQuizDAO2 dao = new VocabQuizDAO2();
	...
	//-------------------------
		...
		public VocabQuiz2() {
			...
			title = new JLabel("단어 출제 [2] [VocabList]");
...
//			Submit.setBackground(Color.gray);
		...
		public void method() {
			...
			try {
				...
				String sql2 = "SELECT Output1, Output2, Output3, Output4, Output5, Output6, Output7, Output8, Output9, Output10, Output11, Output12 , Output13 ,Output14 ,Output15 ,Output16 FROM VocabQuiz2";
