...
public class QuizFromStudent01 extends WindowAdapter implements ActionListener {
	...
	QuizFromStudent01DAO dao = new QuizFromStudent01DAO();
...
//-------------------------
	...
	public QuizFromStudent01() {
		...
		title = new JLabel("단어 출제 [1] [VocabList]");
...
//		Submit.setBackground(Color.gray);
		...
		Submit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (Out1.getText() != null && Out2.getText() != null && Out3.getText() != null && Out4.getText() != null
						&& Out5.getText() != null && Out6.getText() != null && Out7.getText() != null
						&& Out8.getText() != null && Out9.getText() != null && Out10.getText() != null
						&& Out11.getText() != null && Out12.getText() != null && Out13.getText() != null
						&& Out14.getText() != null && Out15.getText() != null && Out16.getText() != null) {

					String outta1 = Out1.getText();
					String outta2 = Out2.getText();
					String outta3 = Out3.getText();
					String outta4 = Out4.getText();
					String outta5 = Out5.getText();
					String outta6 = Out6.getText();
					String outta7 = Out7.getText();
					String outta8 = Out8.getText();
					String outta9 = Out9.getText();
					String outta10 = Out10.getText();
					String outta11 = Out11.getText();
					String outta12 = Out12.getText();
					String outta13 = Out13.getText();
					String outta14 = Out14.getText();
					String outta15 = Out15.getText();
					String outta16 = Out16.getText();

					dao.list(outta1, outta2, outta3, outta4, outta5, outta6, outta7, outta8, outta9, outta10, outta11,
							outta12, outta13, outta14, outta15, outta16);
				}
			}
	...
	public static void main(String[] args) {
		QuizFromStudent01 sm = new QuizFromStudent01();
		sm.startframe();
	}
	...
	public void method() {
		...
		try {
			...
			String sql2 = "SELECT Output1, Output2, Output3, Output4, Output5, Output6, Output7, Output8, Output9, Output10, Output11, Output12 , Output13 ,Output14 ,Output15 ,Output16 FROM VocabQuiz1";
