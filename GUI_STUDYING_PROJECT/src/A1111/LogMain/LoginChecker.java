...
public class LoginChecker {
	...
	public LoginChecker(String id) {
		...
		JTextArea txtA = new JTextArea("�븘�씠�뵒");
		txtA.setLayout(null);
		// txtA = new JTextArea();
		...
		JTextArea txtB = new JTextArea("鍮꾨�踰덊샇 : ");
		// txtB = new JTextArea();
		...
		JTextArea txtC = new JTextArea("�씠由� : ");
		...
		JTextArea txtD = new JTextArea("二쇱냼 : ");
		...
		JTextArea txtE = new JTextArea("�쑕���룿踰덊샇 : ");
