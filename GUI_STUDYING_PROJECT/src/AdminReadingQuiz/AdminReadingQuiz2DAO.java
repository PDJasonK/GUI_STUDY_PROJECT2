...
public class AdminReadingQuiz2DAO {
	...
	public ArrayList<AdminReadingQuiz2Vo> list(String sending1) {
		ArrayList<AdminReadingQuiz2Vo> list = new ArrayList<AdminReadingQuiz2Vo>();
		try {
