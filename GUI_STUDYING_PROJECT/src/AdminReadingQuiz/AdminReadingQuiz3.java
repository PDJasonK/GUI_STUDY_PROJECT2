...
public class AdminReadingQuiz3  extends WindowAdapter implements ActionListener {
	private JFrame f;
	private JPanel p;
	...
	AdminReadingQuiz3DAO dao = new AdminReadingQuiz3DAO();
	...
	public AdminReadingQuiz3() {

		f = new JFrame("Add First Artidfdmin");
		f.setLayout(null);
		p = new JPanel();
		p.setLayout(null);
		...
		title = new JLabel("[세번째 문제 생성] Third Question");
...
//		f.add(PContent1);
	...
	public static void main(String[] args) {
		AdminReadingQuiz3 ARQ3 = new AdminReadingQuiz3();
		ARQ3.startframe();
	}
	...
	public void method() {
		...
		try {
			...
			String sql2 = "SELECT sending1  FROM readq3";
