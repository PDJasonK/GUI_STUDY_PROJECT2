...
public class AdminReadingQuiz1DAO {
	...
	public ArrayList<AdminReadingQuiz1Vo> list(String sending1) {
		ArrayList<AdminReadingQuiz1Vo> list = new ArrayList<AdminReadingQuiz1Vo>();
		try {
