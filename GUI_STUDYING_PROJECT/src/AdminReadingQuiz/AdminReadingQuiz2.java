...
public class AdminReadingQuiz2 extends WindowAdapter implements ActionListener {
	private JFrame f;
	private JPanel p;
	...
	AdminReadingQuiz2DAO dao = new AdminReadingQuiz2DAO();
	...
	public AdminReadingQuiz2() {

		f = new JFrame("Add Firs123by Admin");
		f.setLayout(null);
		p = new JPanel();
		p.setLayout(null);
		...
		title = new JLabel("[두번째 문제 생성] Second Question");
...
//		f.add(PContent1);
	...
	public static void main(String[] args) {
		AdminReadingQuiz2 ARQ2 = new AdminReadingQuiz2();
		ARQ2.startframe();
	}
	...
	public void method() {
		...
		try {
			...
			String sql2 = "SELECT sending1  FROM readq2";
		...
		try {
			...
			String sql2 = "SELECT sending1  FROM readq13";
