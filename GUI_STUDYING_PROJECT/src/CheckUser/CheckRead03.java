...
import AdminReadingQuiz.AdminReadingQuiz2;
import AdminReadingQuiz.GiveFeedbackDAO1;
import UserPage.HomeScreen;

public class CheckRead03 extends WindowAdapter implements ActionListener {
	private JFrame f;
	private JPanel p;
	...
	CheckRead03DAO dao = new CheckRead03DAO();
	...
	public CheckRead03() {
		...
		title = new JLabel("[세번째 문제 확인] Third Question");
...
//		f.add(PContent1);
	...
	public static void main(String[] args) {
		CheckRead03 ARQ1 = new CheckRead03();
		ARQ1.startframe();
	}
