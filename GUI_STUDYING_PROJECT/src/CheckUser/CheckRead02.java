...
public class CheckRead02  extends WindowAdapter implements ActionListener {
	private JFrame f;
	private JPanel p;
	...
	CheckRead02DAO dao = new CheckRead02DAO();
	...
	public CheckRead02() {
		...
		title = new JLabel("[두번째 문제 확인] Second Question");
...
//		f.add(PContent1);
	...
	public static void main(String[] args) {
		CheckRead02 ARQ1 = new CheckRead02();
		ARQ1.startframe();
	}
	...
	public void method() {
		...
		try {
			...
			String sql2 = "SELECT sending1  FROM readq12";
