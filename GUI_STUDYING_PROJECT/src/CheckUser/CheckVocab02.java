...
import VocabQuiz.VocabQuizDAO1;

 

public class CheckVocab02 extends WindowAdapter implements ActionListener {
	private JFrame f;
	private JPanel p;
	/*
...
//-------------------------
	...
	public CheckVocab02() {
		...
		title = new JLabel("단어 시험 확인 [2] [VocabTEST]");
		 ...
		 * 
		 * Submit = new JButton("SUBMIT"); Submit.setLayout(null); Submit.setBounds(400,
		 * 890, 100, 50);
		 */
	...
	public static void main(String[] args) {
		CheckVocab02 sm = new CheckVocab02();
		sm.startframe();
	}
	...
	public void method1() {
		...
		try {
			...
			String sql2 = "SELECT Output1, Output2, Output3, Output4, Output5, Output6, Output7, Output8, Output9, Output10, Output11, Output12 , Output13 ,Output14 ,Output15 ,Output16 FROM VocabQuizFinished2";
