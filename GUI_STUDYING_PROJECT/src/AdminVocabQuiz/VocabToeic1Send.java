...
//	private JLabel PContent2;
	...
	public VocabToeic1Send() {
		...
		title = new JLabel("단어출제 [1] [Vocab List] ");
...
//		Output1.setEditable(false);
		...
		/*
		 * PContent2 = new JLabel("�몢踰덉㎏ 臾몃떒�쓽 �빐�꽍臾�", JLabel.LEFT);
		 * PContent2.setBounds(30, 380, 500, 500); PContent3 = new
		 * JLabel("�꽭踰덉㎏ 泥ル쾲吏� 臾몃떒�쓽 �빐�꽍臾� ", JLabel.LEFT); PContent3.setBounds(30,
		 * 520, 500, 500);
		 * 
		...
		btn0 = new JButton("愿�由ъ옄 �럹�씠吏�濡� �룎�븘媛�湲�");
		btn0.setLayout(null);
		...
		Submit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				System.out.println(Output1.getSelectedText() + Output2.getSelectedText() + Output3.getSelectedText()
						...
						+ Output7.getSelectedText() + Output8.getSelectedText() + Output9.getSelectedText()
						+ Output10.getSelectedText() + Output11.getSelectedText() + Output12.getSelectedText()
						+ Output13.getSelectedText() + Output14.getSelectedText() + Output15.getSelectedText()
						+ Output16.getSelectedText());
