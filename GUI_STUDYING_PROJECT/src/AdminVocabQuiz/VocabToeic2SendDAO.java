...
public class VocabToeic2SendDAO {
	...
	public ArrayList<VocabToeic2OutVo> list(String Output1, String Output2, String Output3, String Output4,
		...
		ArrayList<VocabToeic2OutVo> list = new ArrayList<VocabToeic2OutVo>();
		try {
...
//				" and contentsC = '" + contents3.toLowerCase() + "'";
			query = "insert into VocabQuiz2(Output1, Output2,Output3,Output4,Output5,Output6,Output7,Output8 , Output9 , Output10 , Output11 , Output12 , Output13 , Output14 , Output15 , Output16) "
					+ "VALUES('" + cta1 + "', '" + cta2 + "', '" + cta3 + "', '" + cta4 + "', '" + cta5 + "', '" + cta6
					+ "', '" + cta7 + "', '" + cta8 + "', '" + cta9 + "', '" + cta10 + "', '" + cta11 + "', '" + cta12
					+ "', '" + cta13 + "', '" + cta14 + "', '" + cta15 + "', '" + cta16 + "')";
