...
public class VocabToeic3OutVo {
	...
	public ArrayList<VocabToeic3OutVo> list(String Output1, String Output2, String Output3, String Output4,
		...
		ArrayList<VocabToeic3OutVo> list = new ArrayList<VocabToeic3OutVo>();
		try {
