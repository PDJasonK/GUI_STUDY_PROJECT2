...
public class ReadingMain1DAO {
	...
	public ArrayList<ReadingMain1Vo> list(String reading1 /* , String sending2, String sending3 */) {
		ArrayList<ReadingMain1Vo> list = new ArrayList<ReadingMain1Vo>();
		try {
...
//				" and contentsC = '" + contents3.toLowerCase() + "'";
			query = "insert into readinguser1 (reading1)" + " VALUES('" + cta /*
																				 * + "', '" + ctb + "', '" + ctc
																				 */ + "')";
