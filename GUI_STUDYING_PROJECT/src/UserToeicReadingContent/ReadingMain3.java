...
import AdminReading.ReadingResult;
...
public class ReadingMain3 extends WindowAdapter implements ActionListener {
	...
	public ReadingMain3() {
		...
		f = new JFrame("Third  Reading Page");
		f.setLayout(null);
		p = new JPanel();
		p.setLayout(null);
		...
		title = new JLabel("세번째 읽기 지문");
		title.setBounds(30, 0, 800, 90);

		review1.setLayout(null);
		review1.setBounds(30, 50, 800, 350);

		PContent1 = new JLabel("[세번째 지문 해석 쓰기] Write Third", JLabel.LEFT);
		...
		btn0.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				ReadingMain2 AP = new ReadingMain2();
...
//		Submit.setBackground(Color.gray);
	...
	public static void main(String[] args) {
		ReadingMain3 sm = new ReadingMain3();
		sm.startframe();
	}
