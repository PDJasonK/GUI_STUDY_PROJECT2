...
public class ReadQuiz03 extends WindowAdapter implements ActionListener {
	private JFrame f;
	private JPanel p;
	...
	ReadQuiz03DAO dao = new ReadQuiz03DAO();
	...
	public ReadQuiz03() {
		...
		title = new JLabel("[세번째 문제 풀기] First Question");
...
//		f.add(PContent1);
	...
	public static void main(String[] args) {
		ReadQuiz03 ARQ1 = new ReadQuiz03();
		ARQ1.startframe();
	}
