...
public class ReadQuiz02 extends WindowAdapter implements ActionListener {
	private JFrame f;
	private JPanel p;
	...
	ReadQuiz02DAO dao = new ReadQuiz02DAO();
	...
	public ReadQuiz02() {
		...
		title = new JLabel("[두번째 문제 풀기] First Question");
...
//		f.add(PContent1);
	...
	public static void main(String[] args) {
		ReadQuiz02 ARQ1 = new ReadQuiz02();
		ARQ1.startframe();
	}
