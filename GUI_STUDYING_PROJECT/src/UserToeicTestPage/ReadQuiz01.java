...
import AdminReadingQuiz.AdminReadingQuiz1DAO;
import UserPage.HomeScreen;

public class ReadQuiz01 extends WindowAdapter implements ActionListener {
	private JFrame f;
	private JPanel p;
	...
	ReadQuiz01DAO dao = new ReadQuiz01DAO();
	...
	public ReadQuiz01() {
		...
		title = new JLabel("[첫번째 문제 풀기] First Question");
...
//		f.add(PContent1);
	...
	public static void main(String[] args) {
		ReadQuiz01 ARQ1 = new ReadQuiz01();
		ARQ1.startframe();
	}
