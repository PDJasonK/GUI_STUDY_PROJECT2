...
import AdminReadingQuiz.AdminReadingQuiz1Vo;

public class ReadQuiz01DAO {
	...
	public ArrayList<ReadQuiz01Vo> list(String sending1) {
		ArrayList<ReadQuiz01Vo> list = new ArrayList<ReadQuiz01Vo>();
		try {
